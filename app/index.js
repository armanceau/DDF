...
const IndexScreen = ({ navigation }) => {
    ...
    //Création table Département et Score
    useEffect(() => {
        db.transaction((tx) => {
        ...
        tx.executeSql(
            //"DROP Table score",
            "CREATE TABLE IF NOT EXISTS score (id_score INTEGER PRIMARY KEY AUTOINCREMENT, best_score INT, date_score TEXT, categorie_score TEXT);",
            [],
            (txObj, resultSet) => {
            // Vérification si la table est vide
            txObj.executeSql(
